...
5. **Return and Parameter Validation**
...
- Packages should export interfaces and be built with New constructors that take Options that use the With pattern
